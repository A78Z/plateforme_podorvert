      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        {submitted ? (
          ...
          >
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-3 px-8 rounded-lg transition transform hover:scale-105 shadow-lg"
            >
              🚀 S’inscrire
            </button>
          </form>
