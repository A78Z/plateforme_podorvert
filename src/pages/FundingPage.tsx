...
import { Handshake, Sprout, Truck, Wrench, ShoppingCart, Droplets, Building, ArrowRight } from 'lucide-react';
...
const FundingPage: React.FC = () => {
  const financialPartners = [
    ...
    {
      logo: '/images/logos/logo-onas.png',
      name: 'ONAS',
      description: 'Soutien logistique et technique pour la mise en œuvre de nos projets d\'assainissement et de reboisement.'
    },
    {
