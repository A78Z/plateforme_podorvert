      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            ...
            >
                ...
                <div className="text-6xl font-bold text-green-800">101</div>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16">
            ...
            >
                ...
                <a href="/pdf/RAPPORT_ACTIVITE_PODOR_VERT.pdf" className="inline-flex items-center px-6 py-3 bg-white border-2 border-green-600 text-green-700 rounded-lg font-semibold hover:bg-green-50 transition-colors duration-300 shadow-sm">
